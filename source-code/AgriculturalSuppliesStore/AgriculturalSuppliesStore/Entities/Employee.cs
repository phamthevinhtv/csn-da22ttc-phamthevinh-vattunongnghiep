...
namespace AgriculturalSuppliesStore.Entities
{
    internal class Employee : IBaseEntity
    {
        ...
        public void Display()
        {
            Console.WriteLine($"| {this.id,-10} | {this.employeeName,-20} | {this.employeeDateOfBirth,-10:d} | {this.employeePhoneNumber,-13} | {this.employeeAddress,-30} | {this.employeePosition,-20} |");
